...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='s1/images/validation',
            seg_map_path='s1/annotations/validation'),
        data_root='data/ACDC',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='s1/images/training',
            seg_map_path='s1/annotations/training'),
        data_root='data/ACDC',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = './work_dirs/fcn_psvt_256x256_25k_acdc'
